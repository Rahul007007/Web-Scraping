...
def find_jobs():
    ...
    for i in jobs:
        ...
        if 'few' in published_date:
            company_name = i.find('h3', class_='joblist-comp-name').text.replace(' ', '')  ## with no whitespace in the front
            skill = i.find('span', class_='srp-skills').text.replace(" ", '')
            more_info = i.h2.a['href']  ## go to subheader a of h2 of i and call the href attribute of a
